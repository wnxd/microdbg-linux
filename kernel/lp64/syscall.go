...
func (sys *Syscall) Emulate_faccessat(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.faccessat(ctx, int32(args[0]), ctx.ToPointer(args[1]), int32(args[2]))
	return uint64(r)
}

func (sys *Syscall) Emulate_openat(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.openat(ctx, int32(args[0]), ctx.ToPointer(args[1]), int32(args[2]), int32(args[3]))
	return uint64(r)
}
...
func (sys *Syscall) Emulate_pipe2(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.pipe2(ctx, ctx.ToPointer(args[0]), int32(args[1]))
	return uint64(r)
}

func (sys *Syscall) Emulate_lseek(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.lseek(ctx, uint32(args[0]), int64(args[1]), int32(args[2]))
	return uint64(r)
}

func (sys *Syscall) Emulate_read(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.read(ctx, uint32(args[0]), ctx.ToPointer(args[1]), args[2])
	return uint64(r)
}

func (sys *Syscall) Emulate_write(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.write(ctx, uint32(args[0]), ctx.ToPointer(args[1]), args[2])
	return uint64(r)
}

func (sys *Syscall) Emulate_writev(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.writev(ctx, uint32(args[0]), ctx.ToPointer(args[1]), args[2])
	return uint64(r)
}

func (sys *Syscall) Emulate_readlinkat(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.readlinkat(ctx, int32(args[0]), ctx.ToPointer(args[1]), ctx.ToPointer(args[2]), args[3])
	return uint64(r)
}

func (sys *Syscall) Emulate_newfstatat(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.newfstatat(ctx, int32(args[0]), ctx.ToPointer(args[1]), ctx.ToPointer(args[2]), int32(args[3]))
	return uint64(r)
}

func (sys *Syscall) Emulate_fstat(ctx linux.Context, args ...uint64) uint64 {
	r := sys.fcntl.fstat(ctx, uint32(args[0]), ctx.ToPointer(args[1]))
	return uint64(r)
}
...
func (sys *Syscall) Emulate_futex(ctx linux.Context, args ...uint64) uint64 {
	r := sys.futex.futex(ctx, ctx.ToPointer(args[0]), int32(args[1]), uint32(args[2]), ctx.ToPointer(args[3]), ctx.ToPointer(args[4]), uint32(args[5]))
	return uint64(r)
}

func (sys *Syscall) Emulate_clock_gettime(ctx linux.Context, args ...uint64) uint64 {
	r := sys.clock_gettime(args[0], ctx.ToPointer(args[1]))
	return uint64(r)
}

func (sys *Syscall) Emulate_rt_sigaction(ctx linux.Context, args ...uint64) uint64 {
	r := sys.signal.rt_sigaction(ctx, int32(args[0]), ctx.ToPointer(args[1]), ctx.ToPointer(args[2]), args[3])
	return uint64(r)
}

func (sys *Syscall) Emulate_rt_sigprocmask(ctx linux.Context, args ...uint64) uint64 {
	r := sys.signal.rt_sigprocmask(ctx, int32(args[0]), ctx.ToPointer(args[1]), ctx.ToPointer(args[2]), args[3])
	return uint64(r)
}

func (sys *Syscall) Emulate_prctl(ctx linux.Context, args ...uint64) uint64 {
	r := sys.prctl.prctl(ctx, int32(args[0]), args[1:]...)
	return uint64(r)
}

func (sys *Syscall) Emulate_gettimeofday(ctx linux.Context, args ...uint64) uint64 {
	r := sys.gettimeofday(ctx.ToPointer(args[0]), ctx.ToPointer(args[1]))
	return uint64(r)
}
...
func (sys *Syscall) Emulate_munmap(ctx linux.Context, args ...uint64) uint64 {
	r := sys.mman.munmap(ctx, args[0], args[1])
	return uint64(r)
}

func (sys *Syscall) Emulate_clone(ctx linux.Context, args ...uint64) uint64 {
	r := sys.sched.clone(ctx, int32(args[0]), ctx.ToPointer(args[1]), ctx.ToPointer(args[2]), ctx.ToPointer(args[3]), ctx.ToPointer(args[4]))
	return uint64(r)
}

func (sys *Syscall) Emulate_execve(ctx linux.Context, args ...uint64) uint64 {
	r := sys.sched.execve(ctx, ctx.ToPointer(args[0]), ctx.ToPointer(args[1]), ctx.ToPointer(args[2]))
	return uint64(r)
}

func (sys *Syscall) Emulate_mmap(ctx linux.Context, args ...uint64) uint64 {
	r := sys.mman.mmap(ctx, args[0], args[1], emulator.MemProt(args[2]), int32(args[3]), int32(args[4]), args[5])
	return r
}

func (sys *Syscall) Emulate_mprotect(ctx linux.Context, args ...uint64) uint64 {
	r := sys.mman.mprotect(ctx, args[0], args[1], emulator.MemProt(args[2]))
	return uint64(r)
}

func (sys *Syscall) Emulate_rt_tgsigqueueinfo(ctx linux.Context, args ...uint64) uint64 {
	r := sys.signal.rt_tgsigqueueinfo(ctx, int32(args[0]), int32(args[1]), int32(args[2]), ctx.ToPointer(args[3]))
	return uint64(r)
}

func (sys *Syscall) Emulate_getrandom(ctx linux.Context, args ...uint64) uint64 {
	r := sys.getrandom(ctx, ctx.ToPointer(args[0]), args[1], uint32(args[2]))
	return uint64(r)
}
